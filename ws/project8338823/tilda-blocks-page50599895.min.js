...
function t1070_init(recId){var rec=document.getElementById('rec'+recId);if(!rec)return;var container=rec.querySelector('.t1070');if(!container)return;t_onFuncLoad('t_card__addFocusOnTab',function(){t_card__addFocusOnTab(recId)});var rows=rec.querySelectorAll('.t1070__row');Array.prototype.forEach.call(rows,function(row){var titles=row.querySelectorAll('.t-card__title');var descriptions=row.querySelectorAll('.t-card__descr');var prices=row.querySelectorAll('.t1070__price');var imageWrappers=row.querySelectorAll('.t1070__imgwrapper');if(titles.length>0)t1070_equalHeight(titles);if(descriptions.length>0)t1070_equalHeight(descriptions);if(prices.length>0)t1070_equalHeight(prices);if(imageWrappers.length>0){t1070_equalHeight(imageWrappers);window.onload=function(){t1070_equalHeight(imageWrappers)}}})}
